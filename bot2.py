...
def get_vector_store(text_chunks):
    ...
    vector_store.save_local("faiss_index_bot2")
...
def user_input(user_question):
    embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001", google_api_key=GOOGLE_API_KEY)
    new_db = FAISS.load_local("faiss_index_bot2", embeddings, allow_dangerous_deserialization=True)
...
output_dict = user_input("What laws protect me if i am a girl")
